...
public class Encryption {
    ...
    public static void operate(int key) {
        ...
        try {
            ...
            fos.close();
            fis.close();
            JOptionPane.showMessageDialog(null, "Your file encrypted successfully");
    ...
    Encryption() {
        ...
        Warning.setText("Remember the key you entered because you will need it while decrypting.");
